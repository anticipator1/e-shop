				...
				{({ errors, touched }) => (
					<Form className="w-full flex flex-col justify-center mx-auto mt-10">
						...
						<Field
							name="email"
							type="email"
							className="block mt-2 mb-5 w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-100 sm:text-sm sm:leading-6"
						/>
